// 檔案名稱: Calendar7.js
// 這個組件顯示了一個可篩選的日曆視圖，允許用戶根據狀態、開始日期和結束日期篩選事件
// 使用了 React 的狀態管理和 MUI (Material-UI) 元件來構建用戶介面

import React, { useEffect, useState } from 'react'; // 從 React 匯入必要的 Hook: useEffect, useState
import MyCalendar7 from './calendars/MyCalendar7'; // 匯入自定義的 MyCalendar7 日曆組件
